...
// const { name, age, homeWorld: { name: planetName }, description: { jedi: test } } = character;

// console.log(`Esse é o ${name}, ele tem ${age} anos, mora no planeta ${planetName} e, por incrível que possa parecer, ele ${test ? 'é um Jedi' : 'não é um Jedi'}.`);
